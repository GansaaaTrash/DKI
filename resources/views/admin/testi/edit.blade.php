...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="col-lg-8">
        <form action="{{route('testi.update', $item->id)}}" enctype="multipart/form-data" method="post">
                @csrf
                @method("PUT")
                ...
                <div class="mb-3">
                    <label for="Description" class="form-label @error('Nama') is-invalid @enderror">Deskripsi</label>
