...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="col-lg-8">
        <form action="{{route('admin.update', $item->id)}}" enctype="multipart/form-data" method="post">
                @csrf
                @method("PUT")
                ...
                <div class="modal-body">					
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" style="height: 400px " name="Description"  required>{{$item->Description}}</textarea>
                    </div>
                    <div class="form-group">
                        <label>Gambar</label>
                        <input type="file" name="img1" value="{{$item->img1}}" class="form-control">
                        <img src="{{asset('img1/'.$item->img1)}}" alt="img1">
                    </div>		
                    
                    <div class="form-group">
                        <label>Gambar</label>
                        <input type="file" name="img2" value="{{$item->img2}}" class="form-control" >
                        <img src="{{asset('img2/'.$item->img2)}}" alt="img2">
                    </div>	

                    <div class="form-group">
                        <label>Gambar</label>
                        <input type="file" name="img3" value="{{$item->img3}}" class="form-control" >
