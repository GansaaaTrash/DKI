...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="col-lg-8">
        <form action="{{route('visi.update', $items->id)}}" enctype="multipart/form-data" method="post">
                @csrf
                @method("PUT")
                <div class="modal-header">						
                    ...
                    <div class="form-group">
                        <label>Gambar</label>
                        <input type="file" name="img" value="{{$items->img}}" class="form-control">
                        <img src="{{asset('img/'.$items->img)}}" alt="img">
                    </div>		
